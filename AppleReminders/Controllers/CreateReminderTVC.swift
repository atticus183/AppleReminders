...
class CreateReminderTVC: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        case 0:
            ...
            case 0:
                ...
                reminderNameCell.setupTextInputTVCell(with: tempReminder?.name ?? "", placeholderText: "Title")
            ...
            case 1:
                ...
                noteCell.setupTextInputTVCell(with: tempReminder?.note ?? "", placeholderText: "Notes")
            ...
            case 2:
                ...
                urlCell.setupTextInputTVCell(with: tempReminder?.url ?? "", placeholderText: "URL")
        ...
        case 2:
            ...
            case 0:
                ...
                return locationCell
            case 1:
                subTitleCell.textLabel?.text = "Location"
        ...
        case 4:
            switch indexPath.row {
            case 0: //Flagged
                toggleCell.setupToggleTVCell(with: "Flagged", isSwitchOn: tempReminder?.isFlagged ?? false)
            ...
            case 1: //Priority
                ...
                cell.detailTextLabel?.text = tempReminder?.priority.capitalizeFirstLetter() ?? "None"
    ...
    override func tableView(_ tableView: UITableView, viewForFooterInSection section: Int) -> UIView? {
        ...
        case 3:
            ...
            footerView.textLbl.text = "Selecting this option will show the reminder notification when chatting with a person in Messages."
            return footerView
        default:
            return nil
        }
